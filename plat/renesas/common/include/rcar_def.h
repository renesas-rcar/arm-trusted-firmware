...
#define RCAR_M3NM3L_IDENT 		U(0xE6060800) /*Detect M3L || M3N*/
#define RCAR_M3N_IDENT_VAL 		U(0x00000000)
#define RCAR_M3L_IDENT_VAL     	U(0x00000001)
...
/*RAA271003*/
#if PMIC_RAA271003
#define RAA271003_ADD_PAGE0	  (0x38U)
#define RAA271003_ADD_PAGE1   (0x39U)
#define RAA271003_ADD_PAGE2   (0x3AU)
#define RAA271003_ADD_PAGE3   (0x3BU)
#define RAA271003_ADD_PAGE4   (0x3CU)
#define RAA271003_ADD_PAGE5   (0x3DU)
#define RAA271003_ADD_PAGE6   (0x3EU)
#define RAA271003_ADD_PAGE7   (0x3FU)

#define KEEP_STATUS_REG       (0x5B)	//0x75B reg
#define BOOT_STATUS_BIT       (BIT(0))
#define BOOT_STATUS_BIT_WARM  (BIT(0))
#define SYSTEM_RST_BIT_RST    (BIT(1))
#define SYSTEM_RST_BIT_RST_RST (BIT(1))
#define KEEP_STATUS_CLEAN_VAL (0U)

#define IO_GPIO9_CONF1_REG			(0x22)	//0x122 reg
#define GPIO9_CONF1_DEFAULT_VAL		(0x41U)
#define GPIO9_CONF1_MEM_RET_CFG_VAL	(0x80U)
#endif
