...
#define MAP_DEVICE_RCAR1		MAP_REGION_FLAT(DEVICE_RCAR_BASE1,	\
					DEVICE_RCAR_SIZE1,		\
...
#define MAP_DEVICE_RCAR3	MAP_REGION_FLAT(DEVICE_RCAR_BASE3,	\
					DEVICE_RCAR_SIZE3,		\
					MT_DEVICE | MT_RW | MT_SECURE)
...
#define MAP_SCMI_CHANNEL	MAP_REGION_FLAT(RCAR_SCMI_CHANNEL_MMU_BASE,	\
